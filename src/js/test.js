...
null == e &&
    (((e = function (t) {
        ...
        (t.parcelRequired7c6 = e)),
    e.register('iQIUW', function (o, i) {
        var e, n;
        (e = void 0 !== t ? t : 'undefined' != typeof window ? window : o.exports),
            (n = function (t) {
                ...
                var o,
                            ...
                            var e = function (i) {
                                for (var e in i)
                                    Object.prototype.hasOwnProperty.call(i, e) &&
                                        (o &&
                                            '[object Object]' === Object.prototype.toString.call(i[e])
                                            ? (t[e] = f(t[e], i[e]))
                                            : (t[e] = i[e]));
                            };
                            i < arguments.length;
                    ...
                    p = function (s, c, p, y) {
                        ...
                        if (
                            ...
                            var u = {};
                            'object' == typeof p ? (u = p) : 'object' == typeof y && (u = y),
                                (o = f(!0, o, u));
                        }
                        var b,
                            g,
                            w = o[s.toLocaleLowerCase('en')];
                        m++,
                            'string' != typeof c && (c = 'Notiflix ' + s),
                            o.plainText &&
                            ((b = c),
                        ...
                        if (
                            ((h.id = r.wrapID),
                                ...
                                'center-center' === o.position
                                    ? ((h.style.left = o.distance),
                                        ...
                                        (h.style.maxHeight =
                                            'calc((100vh - ' + o.distance + ') - ' + o.distance + ')'),
                            ...
                            var v =
                                t.document.getElementById(r.overlayID) ||
                                t.document.createElement('div');
                            (v.id = r.overlayID),
                                (v.style.width = '100%'),
                                (v.style.height = '100%'),
                                ...
                                (v.style.animationDuration = o.cssAnimation
                                    ? o.cssAnimationDuration + 'ms'
                                    : ''),
                                t.document.getElementById(r.overlayID) ||
                                t.document.body.appendChild(v);
                        }
                        t.document.getElementById(r.wrapID) ||
                        ...
                        (k.id = o.ID + '-' + m),
                            ...
                            o.rtl &&
                            (k.setAttribute('dir', 'rtl'), k.classList.add('nx-rtl-on')),
                            (k.style.fontFamily =
                                '"' +
                                o.fontFamily +
                                '", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif'),
                            o.cssAnimation &&
                            (k.style.animationDuration = o.cssAnimationDuration + 'ms');
                        var N = '';
                        if (
                            (o.closeButton &&
                                'function' != typeof p &&
                        ...
                        if ('left-bottom' === o.position || 'right-bottom' === o.position) {
                            var C = t.document.getElementById(r.wrapID);
                            C.insertBefore(k, C.firstChild);
                        } else t.document.getElementById(r.wrapID).appendChild(k);
                        ...
                        if (z) {
                            var W,
                                ...
                                T = function () {
                                    ...
                                    var o = t.document.getElementById(r.overlayID);
                                    o && h.childElementCount <= 0 && o.classList.add('nx-remove'),
                                        clearTimeout(W);
                                },
                                B = function () {
                                    if (
                ...
                return 'object' == typeof t.Notiflix
                    ? f(!0, t.Notiflix, { Notify: d.Notify })
                    : { Notify: d.Notify };
            }),
